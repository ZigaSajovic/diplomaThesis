...
Nato razvijemo preslikavo redukcije reda in s tem rešimo problem gnezdenega odvajanja \cite{AD2}, saj omogoča implementacije programov, ki delujejo nad odvedljivimi odvodi drugih programov.
...
Diplomsko delo temelji na avtorjevih člankih \cite{opCalProg} \cite{dC++Paper}, kamor bralca usmerimo v zaključnem poglavju (\emph{\nameref{ch:zakSklp}}), v katerem navedemo možnosti, ki jih izpeljana teorija še ponuja.
